shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("m","Migration Rate",0,min=0,max=0.5),
      ...
      actionButton("go","go"),
      div(helpText("popSim simulates allele frequencies for a single biallelic locus in biological populations. 
    ...
    mainPanel(
      plotOutput("plot"),
      helpText("Click the button below to run 100 simulations of 2 populations using the current 
               parameters."),
